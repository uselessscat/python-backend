...
$$
\begin{array}{rclcl}
0.625 \times 2 &=& 1.25 &\Rightarrow& d_{-1} = 1 \\
0.25  \times 2 &=& 0.5  &\Rightarrow& d_{-2} = 0 \\
0.5   \times 2 &=& 1.0  &\Rightarrow& d_{-3} = 1
\end{array}
$$
...
$$
1,0101,1001 \Rightarrow 0\text{x159}
$$

**Resultado final:**

$$
345_{10} = 101011001_2 = 159_{16} = 0\text{x159}
$$
...
1. Convierte $101110_2$ a decimal y hexadecimal.
    ...
    ??? "Ver solución"
        ...
        **Respuesta:** $46_{10}, 0\text{x2E}_{16}$
